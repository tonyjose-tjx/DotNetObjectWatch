...
Namespace ExpressionBuilder.Linq.Dynamic
    ...
    Friend Class Signature : Implements IEquatable(Of Signature)
        ...
        Public Overloads Function Equals(ByVal other As Signature) As Boolean Implements IEquatable(Of ExpressionBuilder.Linq.Dynamic.Signature).Equals
